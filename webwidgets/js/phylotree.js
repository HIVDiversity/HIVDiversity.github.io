(function (global, factory) {
  ...
  var ___namespace$1 = /*#__PURE__*/_interopNamespaceDefault(_$1);
  ...
  */
        ...
        */
        ...
        if (!isLeafNode(node)) {
            ...
            if (options["selectable"]) {
                ...
                .attr("class", "dropdown-item")
                .attr("tabindex", "-1")
                .text("select toggle") // terminal branches")
                .on("click", function(d) {
                    menu_object.style("display", "none");
                    phylotree.modifySelection(
  ...
  class TreeRender {
    constructor(phylotree, options = {}) {
      ...
      this.scales = [1, 1];
      this.size = [1, 1];
      this.fixed_width = [10, 20];   // 8 was 14  15 was 30
    ...
    initialize_svg(svg_element) {
      ...
      if (this.svg !== svg_element) {
        ...
        drawText(o, this.svg._groups[0][0]);
  ...
  this.do_lr();
    ...
    _label_width(_font_size) {
      ...
      this.phylotree.nodes
        ...
        .filter(nodeVisible)
        .forEach(node => {
          let node_width = 12 + 2 * this._nodeLabel(node).length * _font_size * 0.8;
